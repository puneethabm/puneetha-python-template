...
class EnvironmentVariableMapper(Enum):
    ...
    PBM_MODULE_NAME = env.str("PBM_MODULE_NAME", default="puneetha_python_template")

    PBM_LOG_CONFIG_FILE_NAME = env.str("PBM_LOG_CONFIG_FILE_NAME", default="logging.conf")

    PBM_LOG_FILE_PATH = env.str("PBM_LOG_FILE_PATH", default="/var/log/puneetha-python-template.log")
